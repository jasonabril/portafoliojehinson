...
if ($_POST) { /* es postback */
    ...
    if ($nombre != "" && $correo != "") {
        ...
        $mail->IsSMTP();
        $mail->SMTPAuth = true;
        $mail->Host = "https://jehinsonabril.000webhostapp.com/"; // SMTP a utilizar
        $mail->Username = "jehinsonabril@gmail.com"; // Correo completo a utilizar
        $mail->Password = "aqui va la clave de tu correo";
        $mail->Port = 25;
        $mail->From = "jehinsonabril@gmail.com"; //Desde la cuenta donde enviamos
        $mail->FromName = "Jehinson Abril";
        $mail->IsHTML(true);
        ...
        $mail->addBCC("jehinsonabril@gmail.com"); //Copia oculta
        ...
        $mail->addAddress("jehinsonabril@gmail.com");
